...
```
up ctp provider install redislabs/provider-rediscloud:v0.1.0
```
...
spec:
  package: redislabs/provider-rediscloud:v0.1.0
EOF
```

Notice that in this example Provider resource is referencing ControllerConfig with debug enabled.

You can see the API reference [here](https://doc.crds.dev/github.com/redislabs/provider-rediscloud).
